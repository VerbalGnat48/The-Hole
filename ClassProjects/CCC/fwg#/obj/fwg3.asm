...
__for_2122_end:
  ...
  call __function_play_sound_in_channel
__while_2182_start:
__while_2182_continue:
  mov R0, 1
  jf R0, __while_2182_end
  lea R1, [BP-109]
  mov [SP], R1
  lea R1, [BP-110]
  mov [SP+1], R1
...
__if_2289_start:
  mov R1, [BP-5]
  jf R1, __LogicalAnd_ShortCircuit_2292
  lea R3, [BP-5]
  mov [SP], R3
  lea R3, [BP-108]
  mov R4, [BP-111]
  ...
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_2292:
  mov R0, R1
  jf R0, __if_2289_end
  mov R1, 15
  mov [SP], R1
