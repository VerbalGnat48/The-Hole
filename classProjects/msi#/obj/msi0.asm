...
__while_2900_start:
__while_2900_continue:
  mov R0, 1
  jf R0, __while_2900_end
  mov R1, -16777216
  mov [SP], R1
...
__if_3051_start:
  ...
  mov R1, R0
  igt R1, 0
  jt R1, __LogicalOr_ShortCircuit_3056
  call __function_gamepad_left
  mov R2, R0
  igt R2, 0
  or R1, R2
__LogicalOr_ShortCircuit_3056:
  mov R0, R1
  jf R0, __if_3051_end
__if_3060_start:
  mov R0, [BP-61]
  ieq R0, 3
  jt R0, __LogicalOr_ShortCircuit_3067
  mov R1, [BP-61]
  ieq R1, 4
  or R0, R1
__LogicalOr_ShortCircuit_3067:
  jt R0, __LogicalOr_ShortCircuit_3072
  mov R1, [BP-61]
  ieq R1, 2
  or R0, R1
__LogicalOr_ShortCircuit_3072:
  jf R0, __if_3060_end
  mov R0, [BP-45]
  iadd R0, 1
  mov [BP-45], R0
...
__if_3095_start:
  mov R0, [BP-61]
  ieq R0, 3
  jf R0, __LogicalAnd_ShortCircuit_3101
  mov R1, [BP-45]
  ieq R1, 20
  and R0, R1
__LogicalAnd_ShortCircuit_3101:
  jf R0, __if_3095_end
  mov R0, 4
  mov [BP-61], R0
__if_3095_end:
__if_3109_start:
  mov R0, [BP-61]
  ieq R0, 2
  jf R0, __LogicalAnd_ShortCircuit_3115
  mov R1, [BP-45]
  ieq R1, 60
  and R0, R1
__LogicalAnd_ShortCircuit_3115:
  jf R0, __if_3109_end
  mov R0, 3
  mov [BP-61], R0
  mov R0, 0
...
__if_3131_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3136
  mov R2, [BP-44]
  ieq R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3136:
  mov R0, R1
  jf R0, __if_3131_end
  mov R0, 5
  mov [BP-61], R0
...
__if_3207_start:
  mov R0, [BP-61]
  ieq R0, 5
  jt R0, __LogicalOr_ShortCircuit_3214
  mov R1, [BP-61]
  ieq R1, 6
  or R0, R1
__LogicalOr_ShortCircuit_3214:
  jf R0, __if_3207_end
  mov R0, [BP-44]
  iadd R0, 1
  mov [BP-44], R0
...
__if_3223_start:
  mov R0, [BP-61]
  ieq R0, 6
  jf R0, __LogicalAnd_ShortCircuit_3229
  mov R1, [BP-44]
  ieq R1, 40
  and R0, R1
__LogicalAnd_ShortCircuit_3229:
  jf R0, __if_3223_end
  mov R0, 2
  mov [BP-61], R0
  mov R0, 0
...
__if_3243_start:
  mov R0, [BP-61]
  ieq R0, 5
  jf R0, __LogicalAnd_ShortCircuit_3249
  mov R1, [BP-44]
  ieq R1, 20
  and R0, R1
__LogicalAnd_ShortCircuit_3249:
  jf R0, __if_3243_end
  mov R0, 6
  mov [BP-61], R0
__if_3243_end:
...
__if_3385_start:
  ...
  mov R1, [R2]
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_3394
  call __function_get_frame_counter
  mov R2, R0
  imod R2, 3
  ieq R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3394:
  mov R0, R1
  jf R0, __if_3385_end
  mov R1, [BP-64]
  mov R2, [BP-32]
...
__if_3568_start:
  ...
  mov R1, [R2]
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_3581
  mov R3, [BP-64]
  mov R4, [BP-32]
  imul R4, 11
  iadd R3, R4
  ...
  ieq R2, 1
  and R1, R2
__LogicalAnd_ShortCircuit_3581:
  jf R1, __LogicalAnd_ShortCircuit_3593
  mov R3, [BP-63]
  mov R4, [BP-33]
  imul R4, 11
  iadd R3, R4
  ...
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_3593:
  mov R0, R1
  jf R0, __if_3568_end
  mov R0, 0
  mov R1, [BP-63]
...
__for_3627_start:
  ...
  mov R1, [BP-48]
  ilt R0, R1
  jf R0, __for_3627_end
__if_3637_start:
  mov R1, [BP-62]
  jf R1, __LogicalAnd_ShortCircuit_3640
  mov R3, [BP-65]
  mov R4, [BP-32]
  imul R4, 11
  iadd R3, R4
  ...
  ieq R2, 1
  and R1, R2
__LogicalAnd_ShortCircuit_3640:
  jf R1, __LogicalAnd_ShortCircuit_3655
  lea R3, [BP-62]
  mov [SP], R3
  mov R3, [BP-65]
  mov R4, [BP-32]
...
__for_3680_start:
  ...
  mov R1, [BP-47]
  ilt R0, R1
  jf R0, __for_3680_end
__if_3690_start:
  mov R1, [BP-62]
  jf R1, __LogicalAnd_ShortCircuit_3693
  lea R3, [BP-62]
  mov [SP], R3
  mov R3, [BP-64]
  mov R4, [BP-32]
  ...
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_3693:
  mov R0, R1
  jf R0, __if_3690_end
  mov R0, 0
  mov R1, [BP-64]
...
__if_3733_start:
  ...
  iadd R2, R3
  mov R1, [R2]
  jf R1, __LogicalAnd_ShortCircuit_3739
  mov R3, [BP-65]
  mov R4, [BP-33]
  imul R4, 11
  iadd R3, R4
  mov R2, [R3]
  and R1, R2
__LogicalAnd_ShortCircuit_3739:
  jf R1, __LogicalAnd_ShortCircuit_3754
  mov R3, [BP-66]
  mov R4, [BP-32]
  imul R4, 11
  iadd R3, R4
  ...
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_3754:
  mov R0, R1
  jf R0, __if_3733_end
  mov R0, 0
  mov R1, [BP-65]
...
__for_3824_start:
  ...
  mov R1, [BP-49]
  ilt R0, R1
  jf R0, __for_3824_end
  mov R0, 0
  mov [BP-33], R0
__for_3834_start:
  mov R0, [BP-33]
  ilt R0, 20
  jf R0, __for_3834_end
__if_3844_start:
  mov R2, [BP-66]
  mov R3, [BP-32]
  imul R3, 11
  iadd R2, R3
  mov R1, [R2]
  jf R1, __LogicalAnd_ShortCircuit_3850
  mov R3, [BP-63]
  mov R4, [BP-33]
  imul R4, 11
  iadd R3, R4
  mov R2, [R3]
  and R1, R2
__LogicalAnd_ShortCircuit_3850:
  jf R1, __LogicalAnd_ShortCircuit_3865
  mov R3, [BP-66]
  mov R4, [BP-32]
  imul R4, 11
  iadd R3, R4
  ...
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_3865:
  mov R0, R1
  jf R0, __if_3844_end
  mov R0, 0
  mov R1, [BP-63]
...
__for_3824_continue:
  ...
  iadd R1, 1
  mov [BP-32], R1
  jmp __for_3824_start
__for_3824_end:
__if_3874_start:
  mov R0, [BP-54]
  ieq R0, 0
  jt R0, __LogicalOr_ShortCircuit_3881
  mov R1, [BP-62]
  ieq R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_3881:
  jf R0, __if_3874_end
