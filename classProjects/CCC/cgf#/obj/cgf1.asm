...
; location of global variables
  ...
  %define global_GrabTimer 3
  %define global_AceFlag 4
  %define global_Statement 5
  %define global_Cardstack 35
  %define global_PlayerS 36
  %define global_DealerS 37
...
__global_scope_initialization:
  ...
  mov R0, 0
  mov [global_AceFlag], R0
  mov R0, -1
  mov [global_Cardstack], R0
  mov R0, -1
  mov [global_PlayerS], R0
  mov R0, -1
  mov [global_DealerS], R0
  mov SP, BP
  pop BP
  ret
...
__function_clearlist:
  ...
  mov [BP-1], R0
__while_2377_start:
__while_2377_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __while_2377_end
  mov R2, [BP+2]
  mov [SP], R2
  lea R2, [BP-1]
  mov [SP+1], R2
...
__if_2606_start:
  ...
  ieq R0, 2
  jf R0, __if_2606_end
  mov R2, [global_PlayerS]
  mov [SP], R2
  mov R2, [BP+3]
  mov [SP+1], R2
  call __function_push
  mov R1, R0
  mov [global_PlayerS], R1
  mov R0, R1
__if_2606_end:
__if_2596_end:
...
__if_2627_start:
  mov R0, [BP-1]
  ieq R0, 0
  jt R0, __LogicalOr_ShortCircuit_2632
  mov R1, [BP-1]
  igt R1, 10
  or R0, R1
__LogicalOr_ShortCircuit_2632:
  jf R0, __if_2627_end
  mov R0, 10
  mov [BP-1], R0
__if_2627_end:
...
__if_2647_start:
  ...
  iadd R0, R1
  igt R0, 21
  jf R0, __LogicalAnd_ShortCircuit_2654
  mov R1, [BP-1]
  ieq R1, 11
  and R0, R1
__LogicalAnd_ShortCircuit_2654:
  jf R0, __if_2647_end
  mov R0, 1
  mov [BP-1], R0
__if_2647_end:
...
__function_Give_Card:
  ...
  mov [BP-2], R0
__while_2716_start:
__while_2716_continue:
  mov R0, [BP-2]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_2721
  mov R1, [global_AceFlag]
  ine R1, 1
  and R0, R1
__LogicalAnd_ShortCircuit_2721:
  jf R0, __while_2716_end
__if_2725_start:
  mov R1, [BP-2]
  iadd R1, 1
  mov R0, [R1]
  imod R0, 13
  ieq R0, 1
  jf R0, __LogicalAnd_ShortCircuit_2733
  mov R1, [BP+3]
  igt R1, 21
  and R0, R1
__LogicalAnd_ShortCircuit_2733:
  jf R0, __if_2725_end
  mov R0, [BP+3]
  isub R0, 10
  mov [BP+3], R0
...
__while_2716_end:
  ...
  mov [BP-1], R0
__while_2752_start:
__while_2752_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __while_2752_end
  mov R1, [BP-1]
  iadd R1, 3
  mov R0, [R1]
  isub R0, 16
...
__function_Print_Stack:
  ...
  isub SP, 2
__while_2769_start:
__while_2769_continue:
  mov R0, [BP+2]
  ine R0, -1
  jf R0, __while_2769_end
  mov R2, [BP+2]
  iadd R2, 2
  mov R1, [R2]
  mov [SP], R1
...
__if_2837_start:
  ...
  and R0, 0
  cib R0
  jt R0, __LogicalOr_ShortCircuit_2847
  mov R2, [BP+2]
  iadd R2, 1
  mov R1, [R2]
  imod R1, 13
  ige R1, 10
  or R0, R1
__LogicalOr_ShortCircuit_2847:
  jf R0, __LogicalAnd_ShortCircuit_2852
  mov R3, [BP+2]
  iadd R3, 11
  mov R2, [R3]
  iadd R2, 1
  ...
  ieq R1, 1
  and R0, R1
__LogicalAnd_ShortCircuit_2852:
  jf R0, __if_2837_else
  mov R0, 0
  mov [BP+3], R0
  jmp __if_2837_end
__if_2837_else:
__if_2864_start:
  ...
  imod R0, 13
  ieq R0, 1
  jf R0, __LogicalAnd_ShortCircuit_2887
  mov R3, [BP+2]
  iadd R3, 11
  mov R2, [R3]
  iadd R2, 1
  ...
  imod R1, 13
  ieq R1, 0
  jt R1, __LogicalOr_ShortCircuit_2882
  mov R4, [BP+2]
  iadd R4, 11
  mov R3, [R4]
  iadd R3, 1
  ...
  ige R2, 10
  or R1, R2
__LogicalOr_ShortCircuit_2882:
  and R0, R1
__LogicalAnd_ShortCircuit_2887:
  jf R0, __if_2864_end
  mov R0, 0
  mov [BP+3], R0
__if_2864_end:
__if_2837_end:
  mov R0, [BP+3]
__function_BlackJack_Check_return:
  pop R4
  pop R3
  pop R2
  pop R1
...
__function_Print_Text:
  ...
  mov [BP-1], R0
__while_2904_start:
__while_2904_continue:
  mov R0, [BP+4]
  mov R0, [R0]
  cib R0
  jf R0, __while_2904_end
  mov R1, [BP+4]
  mov R1, [R1]
  mov [SP], R1
  call __function_select_region
...
__function_main:
  ...
  cif R1
  mov [SP+1], R1
  mov R1, __literal_string_3183
  mov [SP+2], R1
  mov R1, 0.500000
  mov [SP+3], R1
  call __function_Print_Text
__while_3185_start:
__while_3185_continue:
  call __function_gamepad_button_start
  mov R1, R0
  ilt R1, 0
  mov R0, R1
  jf R0, __while_3185_end
  jmp __while_3185_start
__while_3185_end:
  mov R1, 5
  mov [SP], R1
  call __function_Play_Sound
...
__while_3194_start:
__while_3194_continue:
  mov R0, 1
  jf R0, __while_3194_end
__if_3197_start:
  mov R0, [BP-12]
  ieq R0, 0
  jf R0, __if_3197_end
...
__if_3400_start:
  ...
  mov R0, [R1]
  igt R0, 26
  jf R0, __LogicalAnd_ShortCircuit_3411
  lea R2, [BP-801]
  mov R3, [BP-1]
  imul R3, 15
  iadd R2, R3
  ...
  ile R1, 52
  and R0, R1
__LogicalAnd_ShortCircuit_3411:
  jf R0, __if_3400_end
  mov R2, 1
  mov [SP], R2
  mov R3, [global_Cardstack]
...
__if_3197_end:
  ...
  mov R1, 1
  mov [SP+1], R1
  call __function_Print_Card
  mov R3, [global_PlayerS]
  iadd R3, 1
  mov R2, [R3]
  mov R1, [R2]
  mov [SP], R1
  call __function_Print_Stack
  mov R3, [global_DealerS]
  iadd R3, 1
  mov R2, [R3]
  mov R1, [R2]
  mov [SP], R1
...
__if_3497_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3502
  mov R2, [BP-10]
  ige R2, 15
  and R1, R2
__LogicalAnd_ShortCircuit_3502:
  mov R0, R1
  jf R0, __if_3497_end
  mov R2, [global_PlayerS]
  mov [SP], R2
...
__if_3497_end:
  ...
  mov R2, [BP-15]
  mov [SP+1], R2
  call __function_BlackJack_Check
  mov R1, R0
  mov [BP-15], R1
  mov R0, R1
  mov R4, [global_DealerS]
  iadd R4, 1
  mov R3, [R4]
  mov R2, [R3]
  mov [SP], R2
...
__if_3545_start:
  ...
  mov R1, R0
  ieq R1, 1
  jt R1, __LogicalOr_ShortCircuit_3551
  mov R2, [BP-14]
  ieq R2, 0
  or R1, R2
__LogicalOr_ShortCircuit_3551:
  jf R1, __LogicalAnd_ShortCircuit_3554
  mov R2, [BP-10]
  ige R2, 15
  and R1, R2
__LogicalAnd_ShortCircuit_3554:
  mov R0, R1
  jf R0, __if_3545_end
  mov R3, [global_DealerS]
  iadd R3, 1
  ...
  call __function_sleep
__while_3565_start:
__while_3565_continue:
  mov R0, [BP-6]
  ilt R0, 17
  jf R0, __while_3565_end
  mov R2, [global_DealerS]
  mov [SP], R2
  mov R2, [BP-6]
  mov [SP+1], R2
...
__if_3586_start:
  mov R0, [BP-13]
  ieq R0, 0
  jt R0, __LogicalOr_ShortCircuit_3591
  mov R1, [BP-15]
  ieq R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_3591:
  jt R0, __LogicalOr_ShortCircuit_3595
  mov R1, [BP-16]
  ieq R1, 0
  or R0, R1
__LogicalOr_ShortCircuit_3595:
  jf R0, __if_3586_end
  mov R0, 0
  mov [BP-12], R0
  mov R0, 1
...
__if_3621_start:
  mov R0, [BP-5]
  ieq R0, 21
  jf R0, __LogicalAnd_ShortCircuit_3626
  mov R1, [BP-16]
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_3626:
  jf R0, __if_3621_else
  mov R1, 100
  cif R1
  mov [SP], R1
  mov R1, 30
...
__if_3661_start:
  mov R0, [BP-5]
  ile R0, 21
  jf R0, __LogicalAnd_ShortCircuit_3666
  mov R1, [BP-6]
  igt R1, 21
  and R0, R1
__LogicalAnd_ShortCircuit_3666:
  jf R0, __if_3661_else
  mov R1, 190
  cif R1
  mov [SP], R1
  mov R1, 30
...
__if_3683_start:
  mov R0, [BP-5]
  igt R0, 21
  jf R0, __LogicalAnd_ShortCircuit_3688
  mov R1, [BP-6]
  ile R1, 21
  and R0, R1
__LogicalAnd_ShortCircuit_3688:
  jf R0, __if_3683_else
  mov R1, 190
  cif R1
  mov [SP], R1
  mov R1, 30
...
__if_3715_start:
  ...
  mov R1, [BP-6]
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_3720
  mov R1, [BP-5]
  ile R1, 21
  and R0, R1
__LogicalAnd_ShortCircuit_3720:
  jf R0, __if_3715_end
  mov R1, 190
  cif R1
  mov [SP], R1
...
__literal_string_1917:
  string "0"
__literal_string_2014:
  string "ERROR! FAILED TO ALLOCATE MEMORY"
__literal_string_3163:
  string "PRESS X TO HIT"
__literal_string_3168:
  string "PRESS ENTER"
__literal_string_3173:
  string "(WHEN IN GAME)"
__literal_string_3178:
  string "FOR DEALER\'S TURN"
__literal_string_3183:
  string "PRESS ENTER TO GAMBLE"
__literal_string_3615:
  string "k TIE! k"
__literal_string_3633:
  string "d DEALER BLACKJACK d"
__literal_string_3651:
  string "d BLACKJACK d"
__literal_string_3673:
  string "d PLAYER WINS! d"
__literal_string_3695:
  string "d HOUSE WINS! d"
__literal_string_3709:
  string "d HOUSE WINS! d"
__literal_string_3727:
  string "d PLAYER WINS! d"
