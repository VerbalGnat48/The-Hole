...
void main( void )
{
	...
	int MaxDemons 		= 40;	//7 enemies for 4 rows
	int MaxFire			= 20;
	int MaxShields		= 3;
	int MaxLives		= 3;
	int MinLives		= 1;
	...
	while( true )
	{
		...
		//-----------------------------------------------------
			...
			itoa( Player -> Health, Statement, 10 );
