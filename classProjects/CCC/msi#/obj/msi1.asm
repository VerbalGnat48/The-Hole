...
__if_2377_start:
  ...
  mov [BP-1], R0
__while_2392_start:
__while_2392_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __while_2392_end
__if_2397_start:
  mov R1, [BP-1]
  iadd R1, 12
  mov R0, [R1]
  ...
  iadd R1, 1
  mov [R1], R0
  jmp __while_2392_end
__if_2397_end:
  mov R1, [BP-1]
  iadd R1, 12
  mov R0, [R1]
  mov [BP-1], R0
  jmp __while_2392_start
__while_2392_end:
  jmp __if_2377_end
__if_2377_else:
__if_2418_start:
...
__if_2418_else:
  ...
  mov [BP-1], R0
__while_2441_start:
__while_2441_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __while_2441_end
__if_2446_start:
  mov R1, [BP-1]
  iadd R1, 12
  mov R0, [R1]
  ...
  iadd R1, 12
  mov [R1], R0
  jmp __while_2441_end
__if_2446_end:
  mov R1, [BP-1]
  iadd R1, 12
  mov R0, [R1]
  mov [BP-1], R0
  jmp __while_2441_start
__while_2441_end:
__if_2418_end:
__if_2377_end:
__if_2372_end:
...
__for_2991_continue:
  ...
  iadd R1, 1
  mov [BP-34], R1
  jmp __for_2991_start
__for_2991_end:
__while_3019_start:
__while_3019_continue:
  mov R0, 1
  jf R0, __while_3019_end
  mov R1, -16777216
  mov [SP], R1
...
__if_3151_start:
  ...
  mov R1, R0
  igt R1, 0
  jf R1, __LogicalAnd_ShortCircuit_3156
  mov R2, [BP-48]
  ieq R2, 0
  and R1, R2
__LogicalAnd_ShortCircuit_3156:
  mov R0, R1
  jf R0, __if_3151_end
  mov R0, 5
  mov R1, [BP-58]
...
__if_3199_start:
  ...
  mov R0, [R1]
  ieq R0, 5
  jt R0, __LogicalOr_ShortCircuit_3206
  mov R2, [BP-58]
  mov R1, [R2]
  ieq R1, 6
  or R0, R1
__LogicalOr_ShortCircuit_3206:
  jf R0, __if_3199_end
  mov R0, [BP-48]
  iadd R0, 1
  mov [BP-48], R0
...
__if_3215_start:
  ...
  mov R0, [R1]
  ieq R0, 6
  jf R0, __LogicalAnd_ShortCircuit_3221
  mov R1, [BP-48]
  ieq R1, 40
  and R0, R1
__LogicalAnd_ShortCircuit_3221:
  jf R0, __if_3215_end
  mov R0, 2
  mov R1, [BP-58]
  mov [R1], R0
...
__if_3235_start:
  ...
  mov R0, [R1]
  ieq R0, 5
  jf R0, __LogicalAnd_ShortCircuit_3241
  mov R1, [BP-48]
  ieq R1, 20
  and R0, R1
__LogicalAnd_ShortCircuit_3241:
  jf R0, __if_3235_end
  mov R0, 6
  mov R1, [BP-58]
  mov [R1], R0
__if_3235_end:
  ...
  mov [BP-64], R0
__while_3256_start:
__while_3256_continue:
  mov R0, [BP-64]
  ine R0, -1
  jf R0, __while_3256_end
__if_3261_start:
  mov R1, [BP-64]
  iadd R1, 11
  mov R0, [R1]
...
__if_3267_start:
  ...
  isub R1, 150
  igt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_3277
  mov R2, [BP-64]
  iadd R2, 1
  mov R1, [R2]
  mov R3, [BP-58]
  ...
  ilt R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_3277:
  jf R0, __if_3267_end
__if_3284_start:
...
__while_3256_end:
  ...
  mov [BP-46], R0
__while_3320_start:
__while_3320_continue:
  mov R0, [BP-64]
  ine R0, -1
  jf R0, __while_3320_end
__if_3325_start:
  mov R1, [BP-64]
  iadd R1, 11
  mov R0, [R1]
...
__while_3320_end:
  ...
  mov [BP-64], R0
__while_3440_start:
__while_3440_continue:
  mov R0, [BP-64]
  ine R0, -1
  jf R0, __while_3440_end
__if_3445_start:
  mov R1, [BP-64]
  iadd R1, 11
  mov R0, [R1]
  ieq R0, 5
  jf R0, __if_3445_else
  mov R0, -1
  mov [BP-65], R0
  mov R1, [BP-57]
  mov R0, [R1]
  mov [BP-65], R0
__while_3458_start:
__while_3458_continue:
  mov R0, [BP-65]
  ine R0, -1
  jf R0, __while_3458_end
__if_3463_start:
  mov R1, [BP-65]
  iadd R1, 11
  mov R0, [R1]
...
__if_3536_start:
  ...
  mov [BP-65], R0
__while_3549_start:
__while_3549_continue:
  mov R0, [BP-65]
  ine R0, -1
  jf R0, __while_3549_end
__if_3554_start:
  mov R1, [BP-65]
  iadd R1, 11
  mov R0, [R1]
  ieq R0, 0
  jf R0, __LogicalAnd_ShortCircuit_3560
  mov R1, [BP-51]
  igt R1, 60
  and R0, R1
__LogicalAnd_ShortCircuit_3560:
  jf R0, __if_3554_end
__if_3564_start:
  mov R1, [BP-64]
  mov [SP], R1
  ...
  mov [BP-66], R0
__while_3584_start:
__while_3584_continue:
  mov R0, [BP-66]
  ine R0, -1
  jf R0, __while_3584_end
__if_3589_start:
  mov R1, [BP-66]
  iadd R1, 11
  mov R0, [R1]
  ...
  mov [SP], R1
  call __function_play_sound
  jmp __while_3584_end
__if_3589_end:
  mov R1, [BP-66]
  iadd R1, 12
  mov R0, [R1]
  mov [BP-66], R0
  jmp __while_3584_start
__while_3584_end:
__if_3564_end:
__if_3554_end:
  mov R1, [BP-65]
...
__if_3623_start:
  ...
  mov [BP-65], R0
__while_3636_start:
__while_3636_continue:
  mov R0, [BP-65]
  ine R0, -1
  jf R0, __while_3636_end
__if_3641_start:
  mov R1, [BP-65]
  iadd R1, 11
  mov R0, [R1]
...
__if_3656_start:
  ...
  mov R0, [R1]
  ieq R0, 18
  jt R0, __LogicalOr_ShortCircuit_3663
  mov R2, [BP-64]
  iadd R2, 7
  mov R1, [R2]
  ieq R1, 12
  or R0, R1
__LogicalOr_ShortCircuit_3663:
  jt R0, __LogicalOr_ShortCircuit_3668
  mov R2, [BP-64]
  iadd R2, 7
  mov R1, [R2]
  ieq R1, 6
  or R0, R1
__LogicalOr_ShortCircuit_3668:
  jf R0, __if_3656_end
  mov R1, [BP-64]
  mov R0, [R1]
  iadd R0, 1
...
__if_3728_end:
  ...
  mov [BP-64], R0
__while_3810_start:
__while_3810_continue:
  mov R0, [BP-64]
  ine R0, -1
  jf R0, __while_3810_end
  mov R1, 0
  mov [SP], R1
  call __function_select_texture
  mov R2, [BP-64]
